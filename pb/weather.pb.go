...
type Value struct {
	...
	Unit  string  `protobuf:"bytes,2,opt,name=unit,proto3" json:"unit,omitempty"` // e.g. "in", "f", "c" ...
}
...
type Record struct {
	...
	Temperature *Value               `protobuf:"bytes,3,opt,name=temperature,proto3" json:"temperature,omitempty"`
	Rain        *Value               `protobuf:"bytes,4,opt,name=rain,proto3" json:"rain,omitempty"`
}
...
func (x *Record) GetStation() string {
	if x != nil {
		return x.Station
	}
	return ""
...
func (x *Record) GetTemperature() *Value {
	if x != nil {
...
var file_weather_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x31, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x14, 0x0a,
	...
	0x09, 0x52, 0x04, 0x75, 0x6e, 0x69, 0x74, 0x22, 0x9e, 0x01, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f,
	...
	,
...
var file_weather_proto_goTypes = []interface{}{
	(*Value)(nil),               // 0: pb.Value
	(*Record)(nil),              // 1: pb.Record
	(*timestamp.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_weather_proto_depIdxs = []int32{
	2, // 0: pb.Record.time:type_name -> google.protobuf.Timestamp
	0, // 1: pb.Record.temperature:type_name -> pb.Value
	0, // 2: pb.Record.rain:type_name -> pb.Value
